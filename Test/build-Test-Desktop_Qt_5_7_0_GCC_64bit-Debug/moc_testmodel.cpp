...
const QMetaObject TestModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_TestModel.data,
      qt_meta_data_TestModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
